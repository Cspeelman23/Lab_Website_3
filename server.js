...
app.get('/team_stats', function(req,res) {
	...
	var query2 = 'SELECT COUNT(*) AS win_games FROM football_games WHERE home_score > visitor_score;';
	var query3 = 'SELECT COUNT(*) AS lost_games FROM football_games WHERE home_score < visitor_score;';
	db.task('get-everything', task => {
	    return task.batch([
		task.any(query1),
		task.any(query2),
